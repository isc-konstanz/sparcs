...
class Meter(Component):
    ...
    ENERGY_L1_ACTIVE = Constant(float, "l1_active_energy", "Phase 1 Active Energy", "kWh")
    ENERGY_L2_ACTIVE = Constant(float, "l2_active_energy", "Phase 2 Active Energy", "kWh")
    ENERGY_L3_ACTIVE = Constant(float, "l3_active_energy", "Phase 3 Active Energy", "kWh")
    ENERGY_ACTIVE = Constant(float, "active_energy", "Active Energy", "kWh")

    ENERGY_L1_REACTIVE = Constant(float, "l1_reactive_energy", "Phase 1 Reactive Energy", "kWh")
    ENERGY_L2_REACTIVE = Constant(float, "l2_reactive_energy", "Phase 2 Reactive Energy", "kWh")
    ENERGY_L3_REACTIVE = Constant(float, "l3_reactive_energy", "Phase 3 Reactive Energy", "kWh")
    ENERGY_REACTIVE = Constant(float, "reactive_energy", "Reactive Energy", "kWh")

    ENERGY_L1_APPARENT = Constant(float, "l1_apparent_energy", "Phase 1 Apparent Energy", "kWh")
    ENERGY_L2_APPARENT = Constant(float, "l2_apparent_energy", "Phase 2 Apparent Energy", "kWh")
    ENERGY_L3_APPARENT = Constant(float, "l3_apparent_energy", "Phase 3 Apparent Energy", "kWh")
    ENERGY_APPARENT = Constant(float, "apparent_energy", "Total Apparent Energy", "kWh")

    ENERGY_L1_IMPORT = Constant(float, "l1_import_energy", "Phase 1 Imported Energy", "kWh")
    ENERGY_L2_IMPORT = Constant(float, "l2_import_energy", "Phase 2 Imported Energy", "kWh")
    ENERGY_L3_IMPORT = Constant(float, "l3_import_energy", "Phase 3 Imported Energy", "kWh")
    ENERGY_IMPORT = Constant(float, "import_energy", "Imported Energy", "kWh")

    ENERGY_L1_EXPORT = Constant(float, "l1_export_energy", "Phase 1 Exported Energy", "kWh")
    ENERGY_L2_EXPORT = Constant(float, "l2_export_energy", "Phase 2 Exported Energy", "kWh")
    ENERGY_L3_EXPORT = Constant(float, "l3_export_energy", "Phase 3 Exported Energy", "kWh")
    ENERGY_EXPORT = Constant(float, "export_energy", "Exported Energy", "kWh")
